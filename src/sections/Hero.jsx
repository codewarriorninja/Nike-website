...
const Hero = () => {
  ...
  return (
    <section id="home" 
       className="w-full h-full flex xl:flex-row flex-col justify-center min-h-screen max-container">
       <div className="relative xl:w-2/5 flex-col justify-center items-start w-full max-xl:padding-x pt-28">
         ...
         <h1 className="mt-10 font-palanquin text-8xl max-sm:text-[72px] max-sm:leading-[82px] font-bold">
          ...
          <p className="font-montserrat text-slate-gray text-lg leading-8 mt-6 mb-1 sm:max-w-sm">Discover stylish Nike arrivals, quality comfort,and 
